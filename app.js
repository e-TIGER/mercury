(function(){
  ...
  function upcomingVotes(rc){  
    $("#upcoming_votes").on("click", function(){
     ...
     var upcomingVotesApi = "https://congress.api.sunlightfoundation.com/upcoming_bills?chamber="+callChamber+"&order=scheduled_at&"+xyz+thatThing;
      $("#vote_sched").prepend("<div class='row'><h1 style='text-align: center;' id='headingfut"+displayRoundFut+"'>"+repName+" and the "+callChamber+" will vote</h1><ul class='col-xs-6 col-xs-offset-3 list-group' style='border-style: inset;border-width: 1em; height:20em; width:75%; overflow:hidden; overflow-y:scroll;' id='vote_sched_list"+displayRoundFut+"'></ul></div>");
 ...
 function voteRecDisplay(a){
  ...
  function getRec(fn,ln,prt,id) {
    ...
    $("#vote_rec").prepend("<div class='row'><h1 style='text-align: center;' id='heading"+displayRound+"'>"+fn+" "+ln+" ("+prt+") voted</h1><ul class='col-xs-6 col-xs-offset-3 list-group' style='border-style: inset;border-width: 1em; height:20em; width:75%; overflow:hidden; overflow-y:scroll;' id='vote_rec_list"+displayRound+"'></ul></div>");
  ...
  function launchPage(x) {
    ...
    $("#launch_page").prepend("<div class='col-xs-8 col-xs-offset-2 text-center'><h1>you live in congressional district "+district+" for "+state+".</br>your representatives in congress are</h1></div>")
     $("#launch_page").append("<button type='button' class='btn btn-default btn-block' id="+x.results[0].govtrack_id+">"+x.results[0].title+" "+x.results[0].first_name+" "+x.results[0].last_name+" "+x.results[0].party+"</button></br>"); 
    ...
    $("#launch_page").append("<button type='button' class='btn btn-default btn-block' id="+x.results[1].govtrack_id+">"+x.results[1].title+" "+x.results[1].first_name+" "+x.results[1].last_name+" "+x.results[1].party+"</button></br>"); 
    ...
    $("#launch_page").append("<button type='button' class='btn btn-default btn-block' id="+x.results[2].govtrack_id+">"+x.results[2].title+" "+x.results[2].first_name+" "+x.results[2].last_name+" "+x.results[2].party+"</button></br>"); 
