...
function intiApp() {
  ...
  $("#main-display").after('<div id="contact_us"><div class="col-xs-12 col-md-6 text-center"><form id="gform" method="POST" action="https://script.google.com/macros/s/AKfycbxa_XRw0e4fNlt_KJZSgFr_xfLCr1oDVXpeyfqKzI5TpWhqxzc/exec"><label for="dob">DOB</label><input type="date" class="form-control" id="dob" name="dob" placeholder="DOB"><label class="control-label" for="gender">Gender</label><select class="form-control" name="gender"><option value="male">Male</option><option value="female">Female</option> <option value="other">Other</option></select><button class="btn btn-default" >Submit</button></form></div> <div style="display:none;" id="thankyou_message"><h2><em>Thanks</em> for respong! This helps us improve your experience!</h2></div></div>');
  getGeoCode();
}
