(function(){
 ...
 function voteRecDisplay(a){
  ...
  function launchPage(x) {
    ...
    $("#launch_page").prepend("<div class='col-xs-8 col-xs-offset-2 text-center'><h1>you live in congressional district "+district+" for "+state+".</br>your house representative and senators are</h1></div>")
