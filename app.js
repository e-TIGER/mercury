...
function intiApp() {
  ...
  $("#main-display").after('<div class="col-xs-12 col-md-4 col-md-offset-4 text-center" id="survey"><h2 style="display: inline;">Optional survey</h2><a href="#" id="survey_close" style="display: inline;">X close</a><form id="gform" method="POST" action="https://script.google.com/macros/s/AKfycbxa_XRw0e4fNlt_KJZSgFr_xfLCr1oDVXpeyfqKzI5TpWhqxzc/exec"><label for="dob">DOB</label><input type="date" class="form-control" id="dob" name="dob"><label class="control-label" for="gender">Gender</label><select class="form-control" name="gender"><option value="male">Male</option><option value="female">Female</option> <option value="other">Other</option></select><label for="email">Enter email to validate survey</label><input type="email" name="email" class="form-control" placeholder="Please enter email, we promise no spam"><button class="btn btn-default">Submit</button></form><div style="display:none;" id="thankyou_message"><h2>Thanks for helping us improve your experience!</h2></div></div>');
  getGeoCode();
}
