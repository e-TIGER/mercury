(function(){
 ...
 function voteRecDisplay(a){
  ...
  function launchPage(x) {
    ...
    $("#launch_page_buttons").prepend("<div class='col-xs-8 col-xs-offset-2 text-center'><h1>you live in congressional district "+district+" for "+state+".</br>your representatives in congress are</h1></div>")
     $("#launch_page_buttons").append("<button type='button' class='btn btn-default btn-block' id="+x.results[0].govtrack_id+">"+x.results[0].title+" "+x.results[0].first_name+" "+x.results[0].last_name+" "+x.results[0].party+"</button></br>"); 
    ...
    $("#launch_page_buttons").append("<button type='button' class='btn btn-default btn-block' id="+x.results[1].govtrack_id+">"+x.results[1].title+" "+x.results[1].first_name+" "+x.results[1].last_name+" "+x.results[1].party+"</button></br>"); 
    ...
    $("#launch_page_buttons").append("<button type='button' class='btn btn-default btn-block' id="+x.results[2].govtrack_id+">"+x.results[2].title+" "+x.results[2].first_name+" "+x.results[2].last_name+" "+x.results[2].party+"</button></br>"); 
