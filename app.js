...
function intiApp() {
  ...
  $("#main-display").append("<div class='col-xs-12 col-md-12 center-block text-center' id='launch_page'><div class='col-xs-8 col-xs-offset-2 col-md-6 col-xs-offset-3' id='launch_page_buttons'></div></div>");
